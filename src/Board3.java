...
public class Board3 {
    ...
    public JPanel createContinents3(Map<String, Country> allCountries, Board board) {
        ...
        JPanel countryA1Panel = a1.draw(new Color(249,225,68));
        ...
        JPanel countryA2Panel = a2.draw(new Color(249,225,68));
        ...
        JPanel countryA3Panel = a3.draw(new Color(249,225,68));
        ...
        JPanel countryA4Panel = a4.draw(new Color(249,225,68));
        ...
        JPanel countryA5Panel = a5.draw(new Color(249,225,68));
        ...
        JPanel countryA6Panel = a6.draw(new Color(249,225,68));
        ...
        JPanel countryB1Panel = b1.draw(new Color(241,115,115));
        ...
        JPanel countryB2Panel = b2.draw(new Color(241,115,115));
        ...
        JPanel countryB3Panel = b3.draw(new Color(241,115,115));
        ...
        JPanel countryB4Panel = b4.draw(new Color(241,115,115));
        ...
        JPanel countryB5Panel = b5.draw(new Color(241,115,115));
        ...
        JPanel countryB6Panel = b6.draw(new Color(241,115,115));
        ...
        JPanel countryC1Panel = c1.draw(new Color(99,189,89));
        ...
        JPanel countryC2Panel = c2.draw(new Color(99,189,89));
        ...
        JPanel countryC3Panel = c3.draw(new Color(99,189,89));
        ...
        JPanel countryC4Panel = c4.draw(new Color(99,189,89));
        ...
        JPanel countryC5Panel = c5.draw(new Color(99,189,89));
        ...
        JPanel countryC6Panel = c6.draw(new Color(99,189,89));
        ...
        JPanel countryD1Panel = d1.draw(new Color(67,80,156));
        ...
        JPanel countryD2Panel = d2.draw(new Color(67,80,156));
        ...
        JPanel countryD3Panel = d3.draw(new Color(67,80,156));
        ...
        JPanel countryD4Panel = d4.draw(new Color(67,80,156));
        ...
        JPanel countryD5Panel = d5.draw(new Color(67,80,156));
        ...
        JPanel countryD6Panel = d6.draw(new Color(67,80,156));
